...
export const mahjongServerPubkeys = [
...
export const clientTag = [
	'client',
	'chiihou',
	'31990:6b0a60cff3eca5a2b2505ccb3f7133d8422045cbef40f3d2c6189fb0b952e7d4:1727582360441',
	defaultRelays[0]
];

interface WindowNostrZap {
	initTarget(elm: HTMLElement): void;
}

declare global {
	interface Window {
		nostrZap?: WindowNostrZap;
	}
}
